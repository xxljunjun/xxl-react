...
const Shopdetail = (props) => {
  ...
  let [messageArr,setMessageArr] = useState([
    {id:1,message:'DJI Mavic 3',title:'¥21988或低至 ¥1007.77/月',txt:'配备 DJI RC Pro 遥控器，自带 1080p 高亮显示屏；套装还包含三块电池、充电管家、多功能收纳包及 ND 镜套装（ND4/8/16/32），进一步提升航拍体验。'},
    {id:2,message:'DJI Mavic 3 畅飞套装',title:'¥21988或低至 ¥1007.77/月',txt:'配备 DJI RC Pro 遥控器，自带 1080p 高亮显示屏； 套装还包含三块电池、充电管家、多功能收纳包及 ND 镜套装（ND4/8/16/32）， 进一步提升航拍体验。'},
    {id:3,message:'DJI Mavic 3 畅飞套装 (DJI RC Pro)',title:'¥21988或低至 ¥1007.77/月',txt:'内含三块电池，且包含充电管家、多功能收纳包及 ND 镜套装（ND4/8/16/32），助你从容应对多种拍摄场景。'},
    {id:4,message:'DJI Mavic 3 Cine 大师套装',title:'¥21988或低至 ¥1007.77/月',txt:'充分包裹桨叶，避免桨叶伤人或因异物撞击而损坏，提高飞行安全。'},
  ])
  ...
  return (
    <div className="shopdetail">
      ...
      <div className="shopmessage">
        ...
        <h3>¥13888</h3>
        <p>低至 ¥636.52/月 × 24 期。<span className="detail">查看详情</span></p>
        <ul>
          {
            listArr.map(item=>{
              return(
      ...
      <div className="txt_box">
        <p>1. 飞行器起飞重量（含电池及桨叶）；最大起飞重量 250 克以下的民用无人机在部分国家或地区免注册；在中华人民共和国境内，最大起飞重量 250 克以上（含250 克）的民用无人机拥有者，需在中国民用航空局进行实名登记，详情请查询并确认当地法规。</p>
        <p>* FCC 标准，在室外空旷无干扰环境下测得，实际距离或因外部环境、使用方式、固件版本的不同有所差异；为保障飞行安全，请遵守相关法律法规，并尽量在视距范围内飞行；以上数据为各标准下单程不返航飞行的最远通信距离，实际飞行时请留意 app 上的返航提示。</p>
        <p>** 光照条件充足，且下方表面纹理丰富、为漫反射材质，飞行器高度在 0.5-30 米时，满足视觉悬停条件。此时垂直和水平定位精度在 ±0.1 米范围内。</p>
        <p>*** 感知范围包含左、右、上、下、前、后六个方向，但并非 360° 全向覆盖；左右两侧感知功能仅在智能跟随、三脚架模式和一键短片下生效。</p>
      </div>
      <Mybottom />
      <Fixcustomer />
      {bottomStatus && (
